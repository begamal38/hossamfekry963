...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'socialProof.fixedStudentCount': 'students currently in academic year 2026',
    ...
    // ══════════════════════════════════════════════════════════════════════════
    // DOWNLOAD / PWA INSTALLATION
    // ══════════════════════════════════════════════════════════════════════════
    'download.title': 'Install the App on Your Device 📱',
    'download.subtitle': 'Make the platform like any other app on your phone or computer - faster to open and easier to use',
    'download.whyInstall': 'Why install the app?',
    'download.benefit.fast': 'Faster to Open',
    'download.benefit.fastDesc': 'App opens instantly from your home screen',
    'download.benefit.performance': 'No Lag',
    'download.benefit.performanceDesc': 'Better performance than regular browser',
    'download.benefit.notifications': 'Instant Notifications',
    'download.benefit.notificationsDesc': 'Know about new sessions and exams',
    'download.benefit.offline': 'Works Offline',
    'download.benefit.offlineDesc': 'Some pages work without internet',
    'download.alreadyInstalled': 'App already installed! ✅',
    'download.usingAsApp': 'You are using the platform as an app now',
    'download.howToInstall': 'How to Install',
    'download.followSteps': 'Follow these steps',
    'download.installNow': 'Install Now',
    'download.orManual': 'Or follow manual steps',
    'download.iosNote': 'iPhone Note:',
    'download.iosNoteDesc': 'You must open the platform from Safari, not Chrome, for "Add to Home Screen" to appear',
    'download.statistics': 'Installation Statistics',
    'download.totalInstalls': 'Total Installs',
    'download.android': 'Android',
    'download.ios': 'iPhone',
    'download.desktop': 'Computer',
    'download.device.android': 'Android',
    'download.device.ios': 'iPhone / iPad',
    'download.device.desktop': 'Computer',
    'download.device.default': 'Your Device',
    'download.step.android.1': 'Open the platform from Chrome',
    'download.step.android.2': 'Tap on ⋮ (three dots) at the top',
    'download.step.android.3': 'Choose "Install App" or "Add to Home Screen"',
    'download.step.android.4': 'Tap "Install"',
    'download.step.ios.1': 'Open the platform from Safari',
    'download.step.ios.2': 'Tap on the share button ⬆️',
    'download.step.ios.3': 'Choose "Add to Home Screen"',
    'download.step.ios.4': 'Tap "Add"',
    'download.step.desktop.1': 'Open the platform from Chrome or Edge',
    'download.step.desktop.2': 'You will find an install icon ⊕ in the address bar',
    'download.step.desktop.3': 'Click on it and choose "Install"',
    'download.step.desktop.4': 'The app will appear in your programs list',
    'download.step.default.1': 'Open the platform from your browser',
    'download.step.default.2': 'Look for "Install" or "Add to Home Screen" option',
    'download.step.default.3': 'Follow the steps',
    'footer.downloadApp': 'Download App',
    'footer.downloadAppBtn': 'Download the App',
    'promotion.downloadApp': 'Download the app on your device',
    'promotion.fasterEasier': 'Faster and easier for studying',
    'promotion.download': 'Download',
    'promotion.installPlatform': 'Install the platform on your device',
  },
  ...
  ar: {
    ...
    'socialProof.fixedStudentCount': 'طالب حاليًا في العام الدراسي 2026',
    ...
    // DOWNLOAD / PWA INSTALLATION
    // ══════════════════════════════════════════════════════════════════════════
    'download.title': 'ثبّت المنصة على جهازك 📱',
    'download.subtitle': 'خلّي المنصة زي أي تطبيق تاني على موبايلك أو الكمبيوتر - أسرع في الفتح وأسهل في الاستخدام',
    'download.whyInstall': 'ليه تثبّت التطبيق؟',
    'download.benefit.fast': 'أسرع في الفتح',
    'download.benefit.fastDesc': 'التطبيق بيفتح فوري من الشاشة الرئيسية',
    'download.benefit.performance': 'مفيش تهنيج',
    'download.benefit.performanceDesc': 'أداء أحسن من المتصفح العادي',
    'download.benefit.notifications': 'إشعارات فورية',
    'download.benefit.notificationsDesc': 'هتعرف بالحصص الجديدة والامتحانات',
    'download.benefit.offline': 'يشتغل أوفلاين',
    'download.benefit.offlineDesc': 'بعض الصفحات تشتغل بدون نت',
    'download.alreadyInstalled': 'التطبيق مثبّت بالفعل! ✅',
    'download.usingAsApp': 'أنت بتستخدم المنصة كتطبيق دلوقتي',
    'download.howToInstall': 'طريقة التثبيت',
    'download.followSteps': 'اتبع الخطوات دي',
    'download.installNow': 'ثبّت التطبيق دلوقتي',
    'download.orManual': 'أو اتبع الخطوات اليدوية',
    'download.iosNote': 'ملاحظة للآيفون:',
    'download.iosNoteDesc': 'لازم تفتح المنصة من Safari مش Chrome عشان خيار "إضافة للشاشة الرئيسية" يظهر',
    'download.statistics': 'إحصائيات التثبيت',
    'download.totalInstalls': 'إجمالي التثبيتات',
    'download.android': 'أندرويد',
    'download.ios': 'آيفون',
    'download.desktop': 'كمبيوتر',
    'download.device.android': 'أندرويد',
    'download.device.ios': 'آيفون / آيباد',
    'download.device.desktop': 'كمبيوتر',
    'download.device.default': 'جهازك',
    'download.step.android.1': 'افتح المنصة من Chrome',
    'download.step.android.2': 'اضغط على ⋮ (النقط التلاتة) فوق',
    'download.step.android.3': 'اختار "تثبيت التطبيق" أو "Add to Home Screen"',
    'download.step.android.4': 'اضغط "تثبيت"',
    'download.step.ios.1': 'افتح المنصة من Safari',
    'download.step.ios.2': 'اضغط على زر المشاركة ⬆️',
    'download.step.ios.3': 'اختار "إضافة إلى الشاشة الرئيسية"',
    'download.step.ios.4': 'اضغط "إضافة"',
    'download.step.desktop.1': 'افتح المنصة من Chrome أو Edge',
    'download.step.desktop.2': 'هتلاقي أيقونة التثبيت ⊕ في شريط العنوان',
    'download.step.desktop.3': 'اضغط عليها واختار "تثبيت"',
    'download.step.desktop.4': 'التطبيق هيظهر في قائمة البرامج',
    'download.step.default.1': 'افتح المنصة من المتصفح',
    'download.step.default.2': 'دور على خيار "تثبيت" أو "Add to Home Screen"',
    'download.step.default.3': 'اتبع الخطوات',
    'footer.downloadApp': 'تحميل التطبيق',
    'footer.downloadAppBtn': 'حمّل التطبيق',
    'promotion.downloadApp': 'حمّل التطبيق على جهازك',
    'promotion.fasterEasier': 'أسرع وأسهل للمذاكرة',
    'promotion.download': 'تحميل',
    'promotion.installPlatform': 'ثبّت المنصة على جهازك',
  },
};

...
const ContentTypeBadgeInner = forwardRef<HTMLDivElement, ContentTypeBadgeProps>(
  ({ isFree, variant = 'default', className }, ref) => {
...
ContentTypeBadgeInner.displayName = 'ContentTypeBadge';

export const ContentTypeBadge = memo(ContentTypeBadgeInner);

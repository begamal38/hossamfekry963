 ...
 * Replaces external URL input with direct file upload to platform storage.
 * 
 * Features:
 ...
 */
export function ExamImageUpload({ value, onChange, disabled = false, isArabic = false }: ExamImageUploadProps) {
          ...
          {uploading ? (
            ...
            <div className="flex flex-col items-center gap-2 text-muted-foreground">
              ...
              <span className="text-sm font-medium">
                {isArabic ? 'اضغط لرفع صورة' : 'Click to upload image'}
              </span>
              <span className="text-xs">
                JPG, PNG, WebP • {isArabic ? 'حتى 5 ميجابايت' : 'Max 5MB'}
              </span>
            </div>
          )}
        </button>

  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-semibold ring-offset-background transition-all duration-150 ease-out focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 active:scale-[0.98] motion-reduce:transform-none motion-reduce:transition-none select-none",
  {
    variants: {
      variant: {
        ...
        // Secondary CTA - less prominent, border-based
        outline: "border border-border bg-transparent text-foreground hover:bg-muted/50 hover:border-primary/40 active:bg-muted/80",
        ...
        // Hero buttons - prominent with glow
        ...
        heroOutline: "border-2 border-primary/60 bg-primary/5 text-primary hover:bg-primary/10 hover:border-primary active:bg-primary/15 backdrop-blur-sm",
        // Glow effect button

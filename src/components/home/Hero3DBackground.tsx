...
export const Hero3DBackground: React.FC = () => {
  return (
    <div className="absolute inset-0 overflow-hidden pointer-events-none z-0">
      ...
      <svg
        className="absolute inset-0 w-full h-full opacity-[0.18] dark:opacity-[0.30]"
      ...
      <div className="absolute top-1/5 left-1/6 w-3 h-3 rounded-full bg-primary/20 dark:bg-primary/30 animate-float-particle blur-[1px]" />
      <div className="absolute top-2/3 right-1/5 w-4 h-4 rounded-full bg-accent/15 dark:bg-accent/25 animate-float-particle-delayed blur-[1px]" />
      <div className="absolute bottom-1/4 left-1/3 w-3 h-3 rounded-full bg-primary/15 dark:bg-primary/25 animate-float-particle-slow blur-[1px]" />
    </div>
  );
};

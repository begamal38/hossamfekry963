          ...
          <div className="bg-background/95 backdrop-blur-sm border border-border rounded-xl shadow-lg p-4">
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="flex-1 min-w-0">
                <p className="text-sm font-medium">حمّل التطبيق على جهازك</p>
                <p className="text-xs text-muted-foreground">أسرع وأسهل للمذاكرة</p>
              </div>
              <Link to="/download">
      ...
      <div className="container mx-auto px-4 py-3">
        <div className="flex items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            ...
            <p className="text-sm">
              <span className="font-medium">ثبّت المنصة على جهازك</span>
              <span className="text-muted-foreground hidden sm:inline"> - أسرع وأسهل للمذاكرة</span>
            </p>
          </div>
